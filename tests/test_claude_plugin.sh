...
jq -e '.name == "cowork" and .plugins[0].name == "cowork" and .plugins[0].source == "./plugins/cowork"' "$marketplace" >/dev/null
jq -e '.owner.name == "Petteri Ponsimaa" and .metadata.version == "1.3.0" and .plugins[0].version == "1.3.0" and .plugins[0].author.name == "Petteri Ponsimaa"' "$marketplace" >/dev/null
jq -e '.name == "cowork" and .version == "1.3.0" and .author.name == "Petteri Ponsimaa"' "$plugin_root/.claude-plugin/plugin.json" >/dev/null
...
for source in codex-build codex-review grill-me-codex grill-with-docs-codex codex-claude-rally cowork-gemini cowork-copilot; do
